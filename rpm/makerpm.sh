...
rpmbuild --define "_sourcedir $PWD/.." --define "_unpackaged_files_terminate_build 0" --buildroot /tmp/gemssbuildroot -bb yamss.spec.hsm
rm -rf /tmp/gemssbuildroot
rpmbuild --define "_sourcedir $PWD/.." --define "_unpackaged_files_terminate_build 0" --buildroot /tmp/gemssbuildroot -bb yamss.spec.client
